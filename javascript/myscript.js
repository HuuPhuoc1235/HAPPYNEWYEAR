...
theTime.add({
	...
	update: function(percent) {
		...
		document.querySelector('.container .sup').innerHTML= "CHÚC MỪNG NẰM MỚi ";
	}
});
theTime.add({
	targets: getHeart,
...
document.querySelector('.Description .modal-title').innerHTML = '<i class="far fa-comment-alt"></i>&nbsp;CHÚC MỪNG NĂM MỚI TẤT CẢ MỌI NGƯỜI';
document.querySelector('.Description .modal-body').innerHTML = 'Happy New Year <i class="fas fa-heart"></i> ';
var author = document.querySelector('.author .me');author.style.opacity = "0.5";

author.innerHTML = "Mọi thắc mắc bạn có thể liên hệ<a href='https://www.facebook.com/chanro.nguyen.7?mibextid=ZbWKwL'>Quốc Định<a>";
